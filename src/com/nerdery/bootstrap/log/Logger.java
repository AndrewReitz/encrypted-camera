package com.nerdery.bootstrap.log;
...
public class Logger {
	...
	/**
	 * A enum for the log levels, this is written as a convenience as to not
	 * require two imports. One for Logger and another for Android's Log class.
	 */
	 ...
	 * Logger.log(this, "Here is my message.");
	 *
	...
	/**
	 * Prints a debug level log with the given class name and message. Ex:
	 * Logger.log("co.nodeath.encrytedcamera.activity.PlayerActivity",
	 * "Here is my message.");
	 *
	...
	/**
	 * Prints a message to the log with the given level, class name, and
	 * message. Ex: Logger.log(Logger.WARN, this, "This is my message.");
	 *
	...
	/**
	 * Prints a message to the log with the given level, class name, and
	 * message. Ex: Logger.log(Logger.WARN,
	 * "co.nodeath.encrytedcamera.activity.PlayerActivity",
	 * "Here is my message.");
	 *
	 * @param logLevel the log level as a {@link LogLevel} enum object
	 * @param className the name of the current class with package
	 ...
	 *
	 * @param logLevel
	 *            the log level as a {@link LogLevel} enum object
	 * @param currentObject
	 ...
	 *            a throwable to log
	 */
	public static void log(LogLevel logLevel, Object currentObject, String message, Throwable throwable) {
	 ...
	 * message. Ex: Logger.log(Logger.WARN,
	 * "co.nodeath.encrytedcamera.activity.PlayerActivity",
	 * "Here is my message.", throwable);
	 *
	 * @param logLevel
	 *            the log level as a {@link LogLevel} enum object
	 * @param className
	 *            the name of the current class with package
	 * @param message
	 *            the message to log
	 * @param throwable
	 *            a throwable to log
	 */
	public static void log(LogLevel logLevel, String className, String message, Throwable throwable) {
		createLogMessage(logLevel, className, message, throwable);
	}

	private static void createLogMessage(LogLevel logLevel, String className, String message, Throwable t) {
